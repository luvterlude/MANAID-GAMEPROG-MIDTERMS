...
public class EnemyBehavior : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var currentColor = player.GetComponent<ColorSwap>().color;

        int randomColorIndex = Random.Range(0, currentColor.Count);
        meshRenderer.material.color = currentColor[randomColorIndex];
